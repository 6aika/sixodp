      ...
      <div class="toolbar">
        <div class="container">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo home_url( $wp->request ) ?>"><?php _e('New Data Request', 'sixodp') ?></a></li>
          </ol>
        </div>
      </div>
                ...
                <div class="row">
                  <div class="col-xs-12">
                    <div class="control-group control-full <?php if (isset($errors['title'])) echo "error" ?>">
                      ...
                      <div class="controls">
                        <input type="text" name="data_request_title" id="data_request_title" class="form-control" value="<?php echo $title; ?>" placeholder="<?php _e('eg. A descriptive title for the data request', 'sixodp') ?>" />
                      </div>
