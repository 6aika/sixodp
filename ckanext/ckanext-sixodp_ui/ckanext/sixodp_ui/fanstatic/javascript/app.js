...
$(function ($) {
  $(document).ready(function(){
    ...
    $( "#resource-edit" ).submit(function() {
      ...
      // Due to CKAN's strange way of not identifying elements properly we need to select the correct submit
      // button with class and name
      $('.btn-primary[name="save"]').append(' ').append($('<span class="icon icon-spinner icon-spin"></span>') );
    });
  });
}(jQuery));
