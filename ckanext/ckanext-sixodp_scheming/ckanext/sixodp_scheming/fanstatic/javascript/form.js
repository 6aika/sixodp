    ...
    $('.multiple-values').each(function() {
        ...
        listContainer.children('div').each(function(valueIndex) {
            if (valueIndex == 0) {
                ...
                var addLink = $('<a href="javascript:void(0);" class="add-input" aria-labelledby="add-label"><span class="icon-plus-sign-alt icon-2x"></span></a>');
...
function createRemoveLink(inputContainer) {
    ...
    var removeLink = $('<a href="javascript:void(0);" class="add-input" aria-labelledby="remove-label"><span class="icon-minus-sign-alt icon-2x"></span></a>');
