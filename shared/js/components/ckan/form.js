$(function() {
        ...
        $('.multiple-values').each(function () {
            ...
            listContainer.children('div').each(function (valueIndex) {
                if (valueIndex == 0) {
                    ...
                    var addLink = $('<a href="javascript:void(0);" class="add-input" aria-labelledby="add-label"><i class="fa fa-plus-square fa-2x"></i></a>');
    ...
    function createRemoveLink(inputContainer) {
        ...
        var removeLink = $('<a href="javascript:void(0);" class="add-input" aria-labelledby="remove-label"><span class="fa fa-minus-square fa-2x"></span></a>');
